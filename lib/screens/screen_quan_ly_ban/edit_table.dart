...
class EditTable extends StatefulWidget {
  const EditTable({super.key});

  @override
  State<EditTable> createState() => _ScreenLoginState();
}

class _ScreenLoginState extends State<EditTable> {
  ...
  void initState() {
    ...
    super.initState();
    tenController.text = _controller.insBan.soThuTu;
  }
          ...
          child: TextButton(
              onPressed: () async {
                ...
                if (isValidated == true) {
                  ...
                  String tb = await _controller.editTable();
