...
import 'package:quan_ly_goi_mon/screens/screen_bep/screen_chitietban_fillfood.dart';

class ScreenFillFood extends StatelessWidget {
       ...
       Column(
        children: [
          Container(
            ...
            child: Column(
              children: [
                Expanded(child: Center(child: Text("${tenMon}", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),))),
                  Card(
            color: Colors.blue,
            child: SizedBox(
              height: 30,
              width: MediaQuery.of(context).size.width/2,
              child: Center(child: Text(" ${controller.soLuong(controller.dsFillFood[tenMon]!)}", style: TextStyle(fontSize: 20, color: Colors.white),),),
            ),
          ),
              ],
            ),
